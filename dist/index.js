...
server.registerTool('isPalindrome', {
    ...
    inputSchema: {
        ...
        ignoreSpaces: z.boolean().optional().describe('Ignore spaces and punctuation (default: false)')
    },
    outputSchema: {
...
server.registerTool('countCharacters', {
    ...
    inputSchema: {
        ...
        includeSpaces: z.boolean().optional().describe('Include spaces in count (default: true)')
    },
    outputSchema: {
